class MyPDO extends PDO {
  public function prepare($query) {
    ...
    return new MyPDOStatement($statement);
  }
}
...
class MyPDOStatement {
  ...
  public function bindValue($key, $value, $mode = null) {
    ...
    if ($mode === null) {
      ...
      return $this->statement->bindValue($key, $value, $mode);
    }
  }
}
...
$db->exec("INSERT INTO categorias (id, nombre, id_categoria_padre) VALUES (1,'Electrodomésticos',NULL),(2,'Consolas y videojuegos',NULL),(3,'Celulares',NULL),(4,'Aires acondicionados',NULL),(5,'Informática',NULL),(6,'Comida',NULL),(7,'Bebida',NULL),(8,'Fruta',6),(9,'Verdura',6),(10,'Carnes',6),(11,'Gaseosa',7),(12,'Bebidas alcohólicas',7),(13,'Aguas saborizadas',7),(14,'Aguas',7),(15,'Portátiles',2),(16,'Hornos',1),(17,'Lavarropas',1),(18,'Heladeras',1),(19,'Microondas',1),(20,'Aires acondicionados frío',4),(21,'Aires acondicionados frío/calor',4),(22,'Computadoras',5),(23,'Impresoras',5),(24,'Notebooks',5),(25,'Televisores',NULL),(26,'Pasta',6);");

$db->exec("CREATE TABLE marcas (
  id INTEGER NOT NULL PRIMARY KEY,
  nombre TEXT NOT NULL
);");

$db->exec("INSERT INTO marcas (id, nombre) VALUES (8,'Apple'),(15,'Coca-Cola'),(1,'HP'),(13,'LG'),(7,'Microsoft'),(9,'Motorola'),(6,'Nintendo'),(14,'Panasonic'),(20,'Patagonia'),(12,'Philco'),(11,'Philips'),(18,'Quilmes'),(2,'Samsung'),(10,'Sanyo'),(17,'Ser'),(5,'Sony'),(16,'Sprite'),(19,'Stella Artois'),(3,'Toshiba'),(4,'TP Link');");
